...
block5.addEventListener('click', () => {
    ...
    RG.src = "assets/images/icons/RGWS.png";
    textBlock.innerHTML = 
    "<p>Brigitta Stone-Johnson</p> <p>Brigitta Stone-Johnson is an artist and architect. She currently lectures at the Wits School of Architecture and Planning, while completing a Creative Practice PhD in Visual Arts at the University of the Witwatersrand. The focus of her work revolves around themes concerning the Anthropocene, posthumanities, and new material theory. Her current work explores the intersectionality between urban landscapes and stoney materials.</p>";
});
...
block8.addEventListener('click', () => {
    ...
    textBlock.innerHTML = 
    "<p>Riley Grant and William Shoki </p> <p>Riley Grant is a Johannesburg-based artist, musician and student currently completing his final year in Visual Arts at the University of the Witwatersrand. William Shoki is a Johannesburg-based writer and philosophy student at the University of the Witwatersrand.</p>";
});
